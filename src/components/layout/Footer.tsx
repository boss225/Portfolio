...
export default function Footer() {
  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row justify-between items-center py-12 px-30 mx-auto relative z-10">
        <div
          className="text-xs uppercase tracking-widest mb-6 md:mb-0"
