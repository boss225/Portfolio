...
export default function Skills() {
  return (
    <section id="skills" className="py-18 px-30 mx-auto relative">
      ...
      <div className="flex flex-col mb-16 relative">
        ...
        <div className="absolute top-0 right-0 opacity-10 pointer-events-none select-none" aria-hidden="true">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* Skills Table + Tools */}
        <div className="md:col-span-2 glass-panel p-8 rounded-xl overflow-x-auto relative">
          <table className="w-full text-left" role="table" aria-label="Technical skills table">
            <thead>
              ...
              >
                ...
                <th className="pb-4 font-bold">Years of Experience</th>
            ...
            <tbody className="text-sm">
              {skills.map((skill) => (
                ...
                >
                  <td className="py-4 font-medium">{skill.name}</td>
                  <td className="py-4" style={{ color: 'var(--color-on-surface-variant)' }}>
                    {skill.years}
                  </td>
                  <td
          ...
          <div className="mt-12">
            ...
            <div className="flex flex-wrap gap-3">
              {tools.map((tool) => (
                <span
                  key={tool.name}
                  className="backdrop-blur-sm px-4 py-2 rounded-lg text-sm border flex items-center gap-2"
                  style={{
        ...
        <div className="flex flex-col gap-8">
          {/* Education */}
          <div className="glass-panel p-8 rounded-xl border-l-4" style={{ borderLeftColor: 'var(--color-primary)' }}>
          ...
          {/* Language */}
          <div className="glass-panel p-8 rounded-xl border-l-4" style={{ borderLeftColor: 'var(--color-secondary)' }}>
